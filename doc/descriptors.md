# Support for Output Descriptors in GallowsBrewingcoin Core

Since GallowsBrewingcoin Core v0.17, there is support for Output Descriptors. This is a
...
on GallowsBrewingcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing GallowsBrewingcoin Core wallets, a convenience function `combo` is
