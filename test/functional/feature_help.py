...
"""Verify that starting gallowsbrewingcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gallowsbrewingcoin with -h for help text")
        ...
        self.log.info("Start gallowsbrewingcoin with -version for version information")
        ...
        self.log.info("Start gallowsbrewingcoind with -fakearg to make sure it does not start")
