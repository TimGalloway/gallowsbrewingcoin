...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gallowsbrewingcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gallowsbrewingcoin-tx [options] <hex-tx> [commands]  Update hex-encoded gallowsbrewingcoin transaction\n" +
            "or:     gallowsbrewingcoin-tx [options] -create [commands]   Create hex-encoded gallowsbrewingcoin transaction\n" +
            "\n";
