...
#if defined(NDEBUG)
# error "GallowsBrewingcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "GallowsBrewingcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("gallowsbrewingcoin-scriptch");
